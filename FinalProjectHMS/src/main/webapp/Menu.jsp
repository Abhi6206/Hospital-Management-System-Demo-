...
<body>
    <nav>
        <div class="logo-name">
            ...
            <span class="logo_name"><h:outputLabel value="Hi #{name}"></h:outputLabel></span>
        </div>
        ...
        <div class="menu-items">
            ...
            <a href="FinalSearch.jsf">Search Claim</a>
            <a href="SearchClaimHistoryNew.jsf">Search Claim History</a>
                </div>
                </li>
                <li><a href="#">
    ...
    <section class="dashboard">
      ...
      <!--   <a href="/" style="text-decoration: none;"><p style="font-size: 18px; font-weight: 600; color:#333333; font-family: sans-serif; cursor: pointer;">Home</p></a> -->
         ...
         <a href="AdminLogin.jsf" style="text-decoration: none;">
