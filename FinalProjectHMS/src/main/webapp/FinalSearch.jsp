...
<h:panelGroup id="StartDateinput" style= "display: #{(param.selectedValue eq 'startdate' or not empty insurance.startdate) ? 'inline-block' : 'none'};">
    <h:outputLabel for="startdate" value="Admit Start Date " /><br/>
    <h:inputText value="#{insurance.startdate}" id="startdate" styleClass="form-control datepicker" autocomplete="off" onfocus="clearInput(this)"  onkeydown="return false"  style="width:210px; height:27px">
...
<h:panelGroup id="EndDateinput" style= "display: #{(param.selectedValue eq 'enddate' or not empty insurance.enddate) ? 'inline-block' : 'none'};">
    <h:outputLabel for="enddate" value ="Admit End Date " /><br/>
    <h:inputText value="#{insurance.enddate}" id="enddate" styleClass="form-control datepicker" autocomplete="off" onfocus="clearInput(this)"  onkeydown="return false"  style="width:210px; height:27px">
        ...
        <br/>
        <h:panelGroup id="radioInput" style= "display: #{(param.selectedValue eq 'matchingType' or not empty insurance.matchingType) ? 'block' : 'none'};">
       <h:selectOneRadio value="#{insurance.matchingType}" id="matchingType" onclick="toggleRadioButton(this)">
     ...
     <br/><br/>
		<center>
        <h:commandButton id="searchButton"  action="#{insController.controllersearchClaimNew(insurance.startdate,insurance.enddate,insurance.providerid, insurance.claim_Id, insurance.uHID, insurance.disease,insurance.matchingType)}" value="Search" style="background-color:#a5d6a7; color:black; width:160px; height:27px">
        
        </h:commandButton>
           <br/><br/>  <h:commandButton  action="#{hibImpl.clear()}"  value="Reset" style="background-color:#e57373; color:black; width:160px; height:27px" /><br/><br/>
  	    </center>
     </h:form>
    <center>
   ...
   <h:form id="claimForm">
        <div class="center">
            <h:panelGroup id="claimPanelGroup" rendered="#{not empty paginationDao.getInsuranceClaimList()}">
				...
				 <h:commandLink action="#{insController.sortbyClaimID()}"
							style="color: black">
					...
					<h:commandLink action="#{insController.sortbyProviderID()}"
							style="color: black">
							<span class="arrow" style="color:blue;">&#8645;</span>
						</h:commandLink>
                    ...
                    <h:commandButton value="#{i.providerid}"
                     action="#{hibImpl.SearchProvider(i.providerid)}" styleClass="commandButtonStyle"
					...
					<h:commandLink action="#{insController.sortbySubscription()}"
							style="color: black">
							<span class="arrow" style="color:blue;">&#8645;</span>
						</h:commandLink>
					</h:outputLabel>
                    ...
                    <h:outputText value="#{i.subscription_Id}"/>
                     ...
                     <f:facet name="header">
                    	...
                    	<h:outputLabel> UHID
					<h:commandLink action="#{insController.sortbyUHID()}"
							style="color: black">
							<span class="arrow" style="color:blue;">&#8645;</span>
						</h:commandLink>
					</h:outputLabel>
                    ...
                    <h:commandButton value="#{i.uHID}"
                     action="#{hibImpl.SearchUHID(i.uHID)}" styleClass="commandButtonStyle" style="background-color: grey; color: black; padding: 10px;"/>
				...
				<h:commandLink action="#{insController.sortbyAdmitDate()}" 
							style="color: black"> 
							<span class="arrow" style="color:blue;">&#8645;</span>
						</h:commandLink>
					</h:outputLabel>
				...
				<h:commandLink action="#{insController.sortbyDiscDate()}"
					...
					<h:commandLink action="#{insController.sortbyBill()}" 
							style="color: black">
							<span class="arrow" style="color:blue;">&#8645;</span>
						</h:commandLink>
					</h:outputLabel>
				...
				<h:commandLink action="#{insController.sortbyMisAmount()}"
							style="color: black">
							<span class="arrow" style="color:blue;">&#8645;</span>
						</h:commandLink>
					</h:outputLabel>
					...
					<h:commandLink action="#{insController.sortbyDisease()}"
							style="color: black">
							<span class="arrow" style="color:blue;">&#8645;</span>
						</h:commandLink>
					</h:outputLabel>
					...
					<h:commandLink action="#{insController.sortbyComments()}"
							style="color: black" styleClass="decoration">
							<span class="arrow" style="color:blue;" >&#8645;</span>
						</h:commandLink>
					</h:outputLabel>
        ...
        <h:outputText value="Page #{paginationDao.currentPage} / #{paginationDao.totalPages}" styleClass="page-info"/>
             ...
             <center>
        <!-- Display the total number of fetched records -->
       <b> <h:outputText value="Current page Records: #{paginationDao.getInsuranceClaimList().size()}" style="color: black; font-size: 19px; font-weight: bold;" /></b>
    </center>
             <center>
    <!-- Display the total number of fetched records -->
    <b><h:outputText id="totalRecords" value="Total Records: #{hibImpl.countRows()}" style="color: black; font-size: 23px; font-weight: bold;" /></b>
</center>
                </center>
                </h:panelGroup>
            </h:form>
